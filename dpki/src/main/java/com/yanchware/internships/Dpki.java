...
public class Dpki extends Contract {
    ...
    public List<ReturnCSREventResponse> getReturnCSREvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = extractEventParametersWithLog(RETURNCSR_EVENT, transactionReceipt);
    ...
    public List<ReturnCertificateByCommonNameEventResponse> getReturnCertificateByCommonNameEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = extractEventParametersWithLog(RETURNCERTIFICATEBYCOMMONNAME_EVENT, transactionReceipt);
    ...
    public List<ReturnCertificateByTokenIdEventResponse> getReturnCertificateByTokenIdEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = extractEventParametersWithLog(RETURNCERTIFICATEBYTOKENID_EVENT, transactionReceipt);
    ...
    public static class certificate extends DynamicStruct {
        ...
        public certificate(String owner, BigInteger token, byte[] publicKey, String commonName, String organizationName, String locality, String state, String emailAddress) {
            super(new org.web3j.abi.datatypes.Address(owner),new org.web3j.abi.datatypes.generated.Uint256(token),new org.web3j.abi.datatypes.generated.Bytes32(publicKey),new org.web3j.abi.datatypes.Utf8String(commonName),new org.web3j.abi.datatypes.Utf8String(organizationName),new org.web3j.abi.datatypes.Utf8String(locality),new org.web3j.abi.datatypes.Utf8String(state),new org.web3j.abi.datatypes.Utf8String(emailAddress));
            this.owner = owner;
            this.token = token;
